...
def test_change_currency_main(browser: WebDriver, base_url: str, currency: str):
...
def test_change_dollar_currency_main(browser: WebDriver, base_url: str, currency: str):
    browser.get(base_url)
